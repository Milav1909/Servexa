...
import { Wrench, AlertCircle, Loader2, ChevronRight } from 'lucide-react';
        ...
        <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Provider Login</h1>
                    <p className="text-slate-500 mt-2 font-medium">Access your service provider dashboard</p>
                </div>
                ...
                <div className="mt-8 text-center space-y-3">
                    <p className="text-sm text-slate-600 font-medium">
                        ...
                        <Link href="/provider/register" className="text-indigo-600 font-semibold hover:text-indigo-700 transition-colors">
